...
namespace Microsoft.Health.Fhir.CosmosDb.Features.Search
{
    internal class FhirCosmosSearchService : SearchService
    {
        ...
        private readonly IgnixaCosmosExpressionRouter _ignixaRouter;
            ...
            : base(searchOptionsFactory, fhirDataStore, logger)
        {
            ...
            _ignixaRouter = new IgnixaCosmosExpressionRouter(ignixaLegacyExpressionBridge, logger);
            _logger = logger;
            ...
            CancellationToken cancellationToken)
        {
            ...
            // Cosmos pipeline consumes searchOptions.Expression. See IgnixaCosmosExpressionRouter for the divergence guard.
            _ignixaRouter.Route(searchOptions);
