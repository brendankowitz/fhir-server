...
namespace Microsoft.Health.Fhir.Core.Features.Persistence
{
    ...
    public class BulkUpdateService : IBulkUpdateService
    {
        ...
        private ResourceElement StampLastUpdated(ResourceElement resourceElement)
        {
            ...
            // NOTE: this native branch is currently unreachable via the public API -- both FhirPathPatchPayload.GetPatchedResourceElement
            // and JsonPatchPayload.GetPatchedResourceElement always round-trip through a Firely POCO before this method runs, so GetIgnixaNode() is always null here today.
